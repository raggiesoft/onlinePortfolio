			...
			switch(strtolower($_GET['age']))
			{
				case "old":
					...
					else
					{
						...
						{
							case "ccdt":
								setTitle("Cordova County Department of Transportation - Older Projects - My Projects");
								break;
							case "openttd":
								setTitle("OpenTTD Installer - Older Projects - My Projects");
								break;
							case "portfolio":
								setTitle("Original Portfolio - Older Projects - My Projects");
								break;
							case "specta":
								setTitle("Specta Gardens - Older Projects - My Projects");
								break;
							case "svdeac":
								setTitle("Shenandoah Valley Disability Employment Awareness Committee - Older Projects - My Projects");
								break;
						}
					}
				case "new":
					...
					else
					{
						...
						{
							case "moon":
								setTitle("Moon Observation Chart - Newer Projects - My Projects");
								break;
							case "portfolio":
								setTitle("My Portfolio - Newer Projects - My Projects");
								break;
							case "wata":
								setTitle("Williamsburg Area Transit Authority - Newer Projects - My Projects");
								break;
							default:
								setTitle("Newer Projects - My Projects");
						}
										...
										switch(strtolower($_GET['age']))
										{
												...
												else
												{
													switch(strtolower($_GET['name']))
													{
														case "openttd":
															...
															break;
														case "portfolio":
															include("projects/old/portfolio.php");
															break;
														case "specta":
															include("projects/old/specta.php");
															break;
														case "svdeac":
															include("projects/old/svdeac.php");
															break;
														default:
															include("projects/old/index.php");
													}
											...
											case "new":
												...
												else
												{
													...
													{
														case "moon":
															include("projects/new/moon.php");
															break;
														case "portfolio":
															include("projects/new/portfolio.php");
															break;
														case "wata":
															include("projects/new/wata.php");
															break;
													}
												}
												break;
